  ...
  <multiple name="elements">
    <tr class="list-header">
      <group column="subrownum">
        <th style="writing-mode:tb-rl;" class="@elements.class@" @elements.cell_attributes;noquote@>
          <if @elements.orderby_url@ not nil>
            ...
            <else>
              <a href="@elements.orderby_url@" title="@elements.orderby_html_title@">@elements.label;noquote@</a> <img src="/resources/acs-templating/sort-neither.png" alt="" />
            </else>
          </if>
          <else>
